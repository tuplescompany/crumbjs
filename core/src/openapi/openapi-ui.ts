...
const redocs = (documentPath: string = '/openapi/document.json') => `
<!DOCTYPE html>
<html>
    <head>
    <title>ReDocUI</title>
...
const redocUIResponse = (documentPath: string = '/openapi/document.json') =>
	new Response(redocs(documentPath), {
		headers: {
			'Content-Type': 'text/html',
		},
	});

export { swagger, redocs, swaggerUIResponse, redocUIResponse };
