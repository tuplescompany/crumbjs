...
function _remove(node: Node, method: string, segments: string[], index: number): void /* should delete */ {
...
function _isEmptyNode(node: Node) {
	return node.methods === undefined && node.static === undefined && node.param === undefined && node.wildcard === undefined;
}
