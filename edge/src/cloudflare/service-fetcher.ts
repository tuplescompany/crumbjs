...
export const useServiceFetcher = (binding: IFetcher) => new ServiceFetcher(binding);
...
export class ServiceFetcher {
	...
	/**
	 * Forwards an incoming `Request` (e.g., from a handler) directly to the bound service,
